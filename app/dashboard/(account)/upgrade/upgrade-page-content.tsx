  ...
  return (
    <div className="max-w-3xl flex flex-col gap-8">
      <div>
        ...
        <p className="text-s,/6 text-gray-600 max-w-prose">
          {plan === "PRO"
            ? "Thank you for supporting PingBonzo. Find your increased usage limits below."
          ...
          <div>
            <p className="text-2xl font-bold">
              ...
              {usageData?.eventsLimit.toLocaleString() ||
                FREE_QUOTA.maxEventsPerMonth.toLocaleString()}
            </p>
          ...
          <div>
            <p className="text-2xl font-bold">
              ...
              {usageData?.categoriesLimit.toLocaleString() ||
                FREE_QUOTA.maxEventCategories.toLocaleString()}
            </p>
            <p className="text-xs/5 text-muted-foreground">
              Events this period
            </p>
