...
export const MockDiscordUI = ({
  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      {/* server list */}
      <div className="hidden sm:flex w-[72px] bg-discord-sidebar-color py-3 flex-col items-center">
        ...
        <div className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-plus-icon-color cursor-not-allowed group">
          <PlusCircle className="text-discord-plus-icon-color  group-hover:text-white transition-all duration-200" />
        </div>
      </div>
    </div>
  )
