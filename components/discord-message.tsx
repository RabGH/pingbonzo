    ...
    <div className="w-full flex items-center justify-start">
      ...
      <div className="w-full max-w-xl">
        <div className="flex items-center">
          ...
          <span className="text-gray-400 pl-1.5 text-xs font-normal">
            {timestamp}
          </span>
        </div>

        <div className="bg-discord-third-color text-sm w-full rounded p-3 mb-4 mt-1.5">
          ...
          {Object.entries(content).map(([key, value]) => (
            <p key={key} className="text-discord-fifth-color text-sm/6">
              <span className="text-discord-offwhite-color">{key}:</span>{" "}
              {value}
            </p>
          ))}

          <p className="text-discord-eleventh-color text-xs mt-2 flex items-center">
